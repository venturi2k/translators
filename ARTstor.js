...
var testCases = [
	{
		"type": "web",
		"url": "http://www.sscommons.org/openlibrary/ExternalIV.jsp?objectId=4jEkdDElLDUzREY6fz58RXlBOXctfFx0dA%3D%3D",
		"items": [
			{
				"itemType": "artwork",
				"title": "Nationalist Soldiers Crossing the Central Plain Between Fukou and Xihua, Henan Province, China 1947",
				"creators": [
					{
						"firstName": "Rowan",
						"lastName": "Roy",
				...
				"date": "1947",
				"abstractNote": "Photographer Roy Rowan's description of this image states that this is a \"single file of Nationalist soldiers as they crossed the Central Plain between Fukou and Xihua. The battalion commander is riding the pony (just left of center). Nationalist and Communist units would often track each other across teh sandy wasteland without engaging in combat.\"",
				"extra": "Work Type: ; Location: China; Subject: China--History--Civil War, 1945-1949;; Collection: Roy Rowan Photographs; SSID: 10881241",
				"libraryCatalog": "ARTstor",
				"rights": "Paul F. Cooper, Jr. Archives at Hartwick College. This digital file may be used for educational purposes only. Prior written permission for any other use. Please credit the Roy Rowan Manuscript Collection,  Paul F. Cooper, Jr. Archives at Hartwick College.; ; This image has been selected and made available by a user using Artstor's software tools. Artstor has not screened or selected this image or cleared any rights to it and is acting as an online service provider pursuant to 17 U.S.C. §512. Artstor disclaims any liability associated with the use of this image. Should you have any legal objection to the use of this image, please visit http://www.artstor.org/our-organization/o-html/copyright.shtml for contact information and instructions on how to proceed.",
				"url": "http://www.sscommons.org/openlibrary/secure/ViewImages?id=4jEkdDElLDUzREY6fz58RXlBOXctfFx0dA%3D%3D&userId=gDFB&zoomparams=&fs=true",
				"attachments": [
					{
						"title": "Artstor Thumbnails"
					}
